...
function RecipeContent() {
  ...
  useEffect(() => {
    if (recipeData?.success) {
      ...
      setSavedRecipeId(recipeData.savedRecipeId || null);
  ...
  useEffect(() => {
    if (saveData?.success) {
      if (saveData.alreadySaved) {
        ...
        setIsSaved(true);
        setSavedRecipeId(saveData.savedRecipe?.documentId);
  ...
  // Main recipe view
  return (
    <div className="min-h-screen bg-stone-50 pt-20 sm:pt-24 pb-12 sm:pb-16 px-3 sm:px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mb-8">
          ...
          <div className="bg-white p-8 md:p-10 border-2 border-stone-200 mb-6">
            {/* Badges */}
            {recipe.imageUrl && (
              <div className="relative w-full h-52 sm:h-64 md:h-72 lg:h-80 overflow-hidden mb-7 rounded-lg">
                <Image
                  src={recipe.imageUrl}
                  alt={recipe.title}
                  fill
            ...
            {/* Title */}
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-stone-900 mb-4 tracking-tight">
              {recipe.title}
            </h1>
            ...
            {/* Meta Info */}
            <div className="flex flex-wrap gap-4 sm:gap-6 text-sm sm:text-base text-stone-600 mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div key={category} className="mb-6 last:mb-0">
                  ...
                  <ul className="space-y-2">
                    {items.map((ingredient, i) => (
                      <li
                        key={i}
                        className="grid grid-cols-[1fr_auto] gap-3 text-sm sm:text-base text-stone-700 py-2 border-b border-stone-100 last:border-0"
                      >
                        <span className="break-words">{ingredient.item}</span>

                        <span className="font-bold text-orange-600 text-right break-words max-w-[120px]">
                          {ingredient.amount}
                        </span>
                      </li>
                    ))}
                ...
                <div className="mt-6 pt-6 border-t-2 border-stone-200">
                  ...
                  >
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-orange-50 p-3 text-center border-2 border-orange-100 rounded-md min-h-[80px] flex flex-col justify-center">
                        <div className="text-xl sm:text-2xl font-bold text-orange-600 break-words leading-tight">
                          {recipe?.nutrition?.calories ?? "-"}
                        </div>
                      ...
                      <div className="bg-stone-50 p-3 text-center border-2 border-stone-100 rounded-md min-h-[80px] flex flex-col justify-center">
                        <div className="text-xl sm:text-2xl font-bold text-stone-900 break-words leading-tight">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white p-8 border-2 border-stone-200">
              ...
              <div>
                {recipe.instructions.map((step, index) => (
                  ...
                  >
                    {/* Step Number */}
                    <div className="absolute -left-4 sm:-left-5 top-0 w-8 h-8 sm:w-10 sm:h-10 bg-orange-600 text-white flex items-center justify-center font-bold border-2 border-orange-700">
                      {step.step}
                    </div>
            ...
            {recipe.substitutions && recipe.substitutions.length > 0 && (
              <div className="bg-white p-5 sm:p-8 border-2 border-stone-200">
                <h2 className="text-2xl font-bold text-stone-900 mb-4 flex items-center gap-2">
